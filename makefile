...
import/websites/gr.maharashtra.gov.in/Soil:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Soil .
...
import: check_env import/websites/gr.maharashtra.gov.in/Soil .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Soil import/documents
